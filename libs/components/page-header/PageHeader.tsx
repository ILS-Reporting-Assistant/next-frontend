...
import { PageHeader as AntPageHeader } from 'antd-v4'
...
export const PageHeader: React.FC<PageHeaderProps> = (props) => {
  ...
  const getTitleFromRouter = () => {
    ...
    const lastPathItem = pathsItems[index].replace(/-/g, ' ') + ' ' + extra
  ...
  return (
    <AntPageHeader
      ...
      style={style}
      {...props}
      title={props.isNavbar ? props.title : <Title>{props.title || getTitleFromRouter()}</Title>}
    />
  )
}
