import { ViewProgressReport } from '~collections'
...
export default function ViewProgressReportPage() {
  ...
  useEffect(() => {
    const fetchReport = async () => {
      ...
      try {
        ...
        router.replace('/progress-reports')
      } finally {
        setLoading(false)
      }
    }
  ...
  return <ViewProgressReport report={report} />
}
